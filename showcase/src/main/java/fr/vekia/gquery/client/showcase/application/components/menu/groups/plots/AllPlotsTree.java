/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr/vekia/gquery/client/showcase/application/components/menu/groups/plots/AllPlotsTree.java $
...
import fr.vekia.gquery.client.showcase.application.demo.items.simple.BarChartExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.BezierCurveExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.BlockPlotExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.BubblePlotExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.DualValuesPlotExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.GaugeExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.LineChartExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.PyramidPlotExempleItem;
import fr.vekia.gquery.client.showcase.application.demo.items.simple.VerticalBarChartExempleItem;
