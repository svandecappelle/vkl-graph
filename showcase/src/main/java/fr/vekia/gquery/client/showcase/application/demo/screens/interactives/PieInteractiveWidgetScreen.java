/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr/vekia/gquery/client/showcase/application/components/menu/groups/interactive/screens/PieInteractiveWidgetScreen.java $
...
import fr.vekia.gquery.client.showcase.application.demo.DataFactory;
...
public class PieInteractiveWidgetScreen extends HorizontalPanel {
	...
	datasTable.getRowFormatter().setStyleName(values.size() + 2, "gwt-ImportantLabel");
	datasTable.getRowFormatter().setStyleName(0, "gwt-DataTableTitle");
	datasTable.getRowFormatter().setStyleName(values.size() + 1, "gwt-DataTableTitle");
