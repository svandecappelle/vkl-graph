/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr/vekia/gquery/client/showcase/application/components/menu/groups/plots/screens/VerticalBarChartExempleScreen.java $
...
public class VerticalBarChartExempleScreen extends AbstractChart<List<Number>> {
	...
	super.setOption(ChartOption.seriesDefaults, SubOption.renderer, "$.jqplot.BarRenderer");

	super.setBooleanOption(ChartOption.seriesDefaults, SubOption.rendererOptions, SubOption.fillToZero, true);
	...
	super.setOption(ChartOption.axes, SubOption.xaxis, SubOption.renderer, "$.jqplot.CategoryAxisRenderer");
	// super.setOption(ChartOption.axes, SubOption.xaxis, SubOption.ticks, dates);

	// Pad the y axis just a little so bars can get close to, but
	// not touch, the grid boundaries. 1.2 is the default padding.
	super.setOption(ChartOption.axes, SubOption.yaxis, "{pad: 1.05, tickOptions: {formatString: '$%d'}}");
	...
	super.setBooleanOption(ChartOption.highlighter, SubOption.showTooltip, true);
	super.setTextOption(ChartOption.highlighter, SubOption.tooltipLocation, "n");
