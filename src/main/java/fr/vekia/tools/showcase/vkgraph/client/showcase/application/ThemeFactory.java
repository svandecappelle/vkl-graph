...
public class ThemeFactory {
	...
	private static void updateStyleSheets() {
		...
		String gwtStyleSheet = "css/themes/" + CUR_THEME + "/" + CUR_THEME
				+ ".css";
		...
		Command callback = new Command() {
			...
			public void execute() {
				...
				// ThemeInjector injectorTheme =
				// ThemeInjector.Util.getInstance();
				// injectorTheme.getPresenter().revealDisplay();
			}
		};
		StyleSheetLoader.loadStyleSheet(gwtStyleSheet,
		...
		// StyleSheetLoader.loadStyleSheet(showcaseStyleSheet,
