/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr.vekia.tools.showcase.vkgraph/client/showcase/application/components/menu/groups/complex/screens/ZoomProxyChartScreen.java $
...
public class ZoomProxyChartScreen extends SimplePanel {
	...
	public ZoomProxyChartScreen() {
		...
		chart1.setBooleanOption(ChartOption.cursor, SubOption.showTooltip,
				false);

		OptionSerie firstDataRendererOptions = new OptionSerie();
		firstDataRendererOptions.setBooleanOption(SubOption.pointLabels,
				SubOption.show, true);

		OptionSerie barDataRendererOptions = new OptionSerie();
		barDataRendererOptions.setOption(SubOption.renderer,
				"$.jqplot.BarRenderer");
		barDataRendererOptions.setTextOption(SubOption.yaxis, "y2axis");
		barDataRendererOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barWidth, 15);
		barDataRendererOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barPadding, -15);
		barDataRendererOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barMargin, 0);
		barDataRendererOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barWidth, 15);
		barDataRendererOptions.setBooleanOption(SubOption.rendererOptions,
				SubOption.highlightMouseOver, false);

		chart1.setOption(ChartOption.seriesDefaults, SubOption.rendererOptions,
				SubOption.animation, "{speed:2000}");
		chart1.setNumberOption(ChartOption.seriesDefaults,
				SubOption.rendererOptions, SubOption.barMargin, 15);
		...
		chartProxy
				.setOption(ChartOption.cursor, SubOption.constrainZoomTo, "x");
