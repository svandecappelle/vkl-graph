/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr.vekia.tools.showcase.vkgraph/client/showcase/application/components/menu/groups/interactive/screens/BarChartInteractiveWidgetScreen.java $
...
public class BarChartInteractiveWidgetScreen extends HorizontalPanel {
	...
	public BarChartInteractiveWidgetScreen() {
		...
		chart.setTextOption(ChartOption.seriesDefaults, SubOption.dragable,
		...
		chart.setNumberOption(ChartOption.axes, SubOption.yaxis, SubOption.min,
				0);
		chart.setNumberOption(ChartOption.axes, SubOption.yaxis, SubOption.max,
				20);
		...
		ticks.add("K");
		ticks.add("L");
		chart.setOption(ChartOption.axes, SubOption.xaxis, SubOption.renderer,
				RenderersEnum.CategoryAxis.getValueRenderer());
		chart.setOption(ChartOption.axes, SubOption.xaxis, SubOption.ticks,
				ticks);
		...
		chart.bind(new DataClickEvent() {
			...
			public void onEvent(EventObject datasOnEvent) {
				...
				eventDataLabelSerie.setText("Serie: "
						+ datasOnEvent.getSeriesIndex());
				eventDataLabelPoint.setText("Point index: "
						+ datasOnEvent.getPointIndex());
