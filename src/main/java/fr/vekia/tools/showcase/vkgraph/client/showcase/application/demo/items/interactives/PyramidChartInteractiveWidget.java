...
public class PyramidChartInteractiveWidget extends HorizontalPanel {
	...
	chart.bind(new DataHighlightEvent() {
		...
		datasTable.setText(1, 1, Integer.toString(datasOnEvent.getPointIndex() + 1));
		String ratio = datasOnEvent.getValue().toString().replaceFirst("([0-9])*,", "");
	...
	chart.setOption(ChartOption.title,
