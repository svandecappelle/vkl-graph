...
public class CalendarScreen extends CalendarChart {
	...
	public CalendarScreen() {
		...
		periods.add(new PeriodCalendar(1f, periodOneFrom, periodOneTo, "lime",
				"Period 1"));
		periods.add(new PeriodCalendar(1.5f, periodTwoFrom, periodTwoTo,
				"orange", "Period 2"));
		periods.add(new PeriodCalendar(2f, periodTwoFrom, periodTwoTo, "red",
				"Period 3"));
		periods.add(new PeriodCalendar(3f, periodThreeFrom, periodThreeTo,
				"lightblue", "Period 4"));
