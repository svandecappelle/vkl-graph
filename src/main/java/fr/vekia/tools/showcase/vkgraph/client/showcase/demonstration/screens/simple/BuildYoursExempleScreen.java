...
public class BuildYoursExempleScreen extends Composite {
    ...
    private void changeWidget(final int rowId, final int columnId, final HasType type, final ChartOption optionChart, SubOption subOption, final List<SubOption> allSubOptions, HasIsOption hasIsOption) {
        Widget widget = null;
