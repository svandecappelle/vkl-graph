/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr.vekia.tools.showcase.vkgraph/client/showcase/application/ShowcasePresenter.java $
 ...
 */
@Singleton
public class ShowcasePresenter extends
		WidgetPresenter<ShowcasePresenter.Display> implements ActivityPresenter {
	...
	public ShowcasePresenter(Display display, EventBus eventBus) {
		...
		ShowcaseConsoleCodePresenter consoleCodePresenter = injector
				.getConsoleCodePresenter();
		consoleCodePresenter.getDisplay().insert();

		ShowcaseGlobalPanelPresenter globalPanelPresenter = injector
				.getGlobalPanelPresenter();
	...
	protected void onBind() {
		eventBus.addHandler(StartAutomatedDemoEvent.getType(),
				new StartAutomatedDemoHandler() {
