/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr.vekia.tools.showcase.vkgraph/client/showcase/application/components/menu/groups/interactive/screens/BubbleInteractiveWidgetScreen.java $
 * $Id: BubbleInteractiveWidgetScreen.java 52 2012-09-26 15:26:35Z svandecappelle $
 * Licence MIT
 *
 * Last change:
...
public class BubbleInteractiveWidgetScreen extends HorizontalPanel {
	...
	public BubbleInteractiveWidgetScreen() {
		...
		chart.setNumberOption(ChartOption.axes, SubOption.xaxis, SubOption.min,
				-20);
		chart.setNumberOption(ChartOption.axes, SubOption.xaxis, SubOption.max,
				70);
