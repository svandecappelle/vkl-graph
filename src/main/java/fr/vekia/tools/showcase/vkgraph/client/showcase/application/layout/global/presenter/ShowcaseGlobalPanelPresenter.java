package fr.vekia.tools.showcase.vkgraph.client.showcase.application.layout.global.presenter;
 ...
 */
@Singleton
public class ShowcaseGlobalPanelPresenter extends WidgetPresenter<GlobalDisplay> {
     ...
     */
    @Inject
    public ShowcaseGlobalPanelPresenter(GlobalDisplay display, EventBus eventBus) {
