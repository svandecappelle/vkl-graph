/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr.vekia.tools.showcase.vkgraph/client/showcase/application/ShowcaseMenuPresenter.java $
...
import fr.vekia.tools.showcase.vkgraph.client.showcase.application.components.menu.groups.complex.ComplexeTree;
import fr.vekia.tools.showcase.vkgraph.client.showcase.application.components.menu.groups.interactive.InteractiveChart;
import fr.vekia.tools.showcase.vkgraph.client.showcase.application.components.menu.groups.pie.PieTree;
import fr.vekia.tools.showcase.vkgraph.client.showcase.application.components.menu.groups.plots.GeneralPlotTree;
