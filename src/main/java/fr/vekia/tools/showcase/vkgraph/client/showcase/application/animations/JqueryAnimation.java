...
public final class JqueryAnimation {
	...
	public static void animateShow(Element element, AnimationEnum animation,
			int duration) {
	...
	public static void animateHide(Element element, AnimationEnum animation,
			int duration) {
		if (element.getId().isEmpty()) {
			element.setId(DOM.createUniqueId());
		}
	...
	private native static void slideToggle(String id, boolean isShow,
			int duration) /*-{
							if (isShow) {
							$wnd.jQuery(id).show("slide", {
							direction : "toggle"
	 ...
	 * @param animation
	 */
	public static void animate(AnimationEnum animation, Element element,
			int times, int duration) {
		if (element.getId().isEmpty()) {
			element.setId(DOM.createUniqueId());
		}
		switch (animation) {
