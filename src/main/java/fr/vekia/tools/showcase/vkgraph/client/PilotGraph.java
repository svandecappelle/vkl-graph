...
public class PilotGraph extends AbstractChart<List<DualValue>> {
	...
	public PilotGraph() {
		...
		lineMaxPermOptions.setOption(SubOption.rendererOptions,
				SubOption.bands, "{showLines: true}");
		lineMaxPermOptions.setOption(SubOption.renderer,
				RenderersEnum.Line.getValueRenderer());
		...
		lineMaxPermOptions
				.setTextOption(SubOption.label, "Stock MaxiPermanent");

		lineMaxPermOptions.setBooleanOption(SubOption.rendererOptions,
				SubOption.smooth, true);
		...
		serieStockMerchAndMax.setTextOption(SubOption.label,
				"Marge Merch / Max");
		...
		serieStockMerchAndMax.setBooleanOption(SubOption.rendererOptions,
				SubOption.smooth, true);
		serieStockMerchAndMax.setOption(SubOption.rendererOptions,
				SubOption.bands, "{showLines: true}");
		...
		barOptions.setOption(SubOption.renderer,
				RenderersEnum.Bar.getValueRenderer());
		barOptions.setBooleanOption(SubOption.rendererOptions,
				SubOption.fillToZero, true);
		barOptions.setBooleanOption(SubOption.showMarker, false);
		barOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barPadding, -50);
		barOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barMargin, 20);
		barOptions.setNumberOption(SubOption.rendererOptions,
				SubOption.barWidth, 50);
		barOptions.setBooleanOption(SubOption.isDragable, true);
		barOptions
				.setTextOption(SubOption.dragable, SubOption.constrainTo, "y");
		barOptions.setTextOption(SubOption.dragable, SubOption.color,
				"rgba(255,0,0,0.4)");
		...
		lineCibleOptions.setOption(SubOption.renderer,
				RenderersEnum.Line.getValueRenderer());
		...
		lineCibleOptions.setNumberOption(SubOption.markerOptions,
				SubOption.size, 15);
		lineCibleOptions.setTextOption(SubOption.markerOptions,
				SubOption.style, "circle");
		...
		super.setOption(ChartOption.axes, SubOption.yaxis,
				...
				RenderersEnum.CanvasAxisTick.getValueRenderer());
		super.setOption(ChartOption.axes, SubOption.yaxis,
				SubOption.tickOptions, "{fontSize: '11pt'}");
		super.setOption(ChartOption.axes, SubOption.yaxis,
				SubOption.labelRenderer,
				RenderersEnum.CanvasAxisLabel.getValueRenderer());
		super.setOption(ChartOption.axes, SubOption.yaxis,
				SubOption.labelsOptions, "{fontSize: '11pt'}");
		super.setTextOption(ChartOption.axes, SubOption.yaxis, SubOption.label,
				"Piece");
		...
		super.setNumberOption(ChartOption.seriesDefaults, SubOption.lineWidth,
				4.5f);
		...
		super.setBooleanOption(ChartOption.seriesDefaults, SubOption.shadow,
				false);
		super.setTextOption(ChartOption.seriesDefaults, SubOption.dragable,
				SubOption.constrainTo, "y");
		super.setBooleanOption(ChartOption.seriesDefaults, SubOption.trendline,
		...
		super.setTextOption(ChartOption.highlighter, SubOption.formatString,
				formatTooltip.toString());
		super.setOption(ChartOption.highlighter,
				SubOption.tooltipFormatCallback, formatBuilder.toString());
		super.setBooleanOption(ChartOption.highlighter, SubOption.fadeTooltip,
				true);
		...
		RootLayoutPanel.get().setWidgetLeftWidth(eventDataLabelSerie, 1000,
				Unit.PX, 100, Unit.PX);
		RootLayoutPanel.get().setWidgetLeftWidth(eventDataLabelValue, 1000,
				Unit.PX, 100, Unit.PX);

		RootLayoutPanel.get().setWidgetTopHeight(eventDataLabelSerie, 10,
				Unit.PX, 20, Unit.PX);
		RootLayoutPanel.get().setWidgetTopHeight(eventDataLabelValue, 40,
				Unit.PX, 20, Unit.PX);
	...
	protected void redrawView(List<DualValue> cibleModifiable) {
		cibleModifiable.set(valueModifiedIndex - 1, new DualValue(
				valueModifiedIndex, valueRoundedModified));
