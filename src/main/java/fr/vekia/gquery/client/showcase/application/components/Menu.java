/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr/vekia/gquery/client/showcase/application/components/Menu.java $
...
import fr.vekia.gquery.client.showcase.application.ShowcaseMenuPresenter.Display;
