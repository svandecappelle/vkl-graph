/*
 * File: $URL: svn+ssh://chimay/home/svn/VkGraph-showcase/VkGraph-showcase/src/main/java/fr/vekia/gquery/client/showcase/application/components/menu/groups/plots/screens/BubblePlotExempleScreen.java $
...
public class BubblePlotExempleScreen extends BubbleChart {
	...
	super.setBooleanOption(ChartOption.seriesDefaults, SubOption.rendererOptions, SubOption.bubbleGradients, true);
	super.setNumberOption(ChartOption.seriesDefaults, SubOption.rendererOptions, SubOption.highlightAlpha, 0.8f, NumberType.FLOAT);
	super.setBooleanOption(ChartOption.seriesDefaults, SubOption.shadow, true);
	super.setNumberOption(ChartOption.seriesDefaults, SubOption.shadowAlpha, 0.05f, NumberType.FLOAT);
