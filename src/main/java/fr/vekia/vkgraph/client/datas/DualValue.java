 ...
 * @version 1.0
 * 
 *          {@inheritDoc} A dual Value bean. Key/Value (Key can be a Number /
 *          String).
 *          <ul>
 *          <li>If the key is String: you should use a</li>
 *          <ul>
 *          <li>If the X-axis is a DateRenderer: You can use the 'dd/mm/yyy'
 *          format or any supported format JavaScript date.You should use the
 *          Timestamp if possible (See below)</li>
 *          <li>If the X-axis is a CategoryRenderer: The label is translated by
 *          a new category.</li>
 *          </ul>
 *          <ul>
 *          <li>If the X-axis is a DateRenderer: You can use the date timestamp.
 *          use {@link java.util.Date#getTime()}</li>
 *          </ul>
 *          </ul>
 */
