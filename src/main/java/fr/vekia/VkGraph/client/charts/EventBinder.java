/*
 * File: $URL: https://vklgraph.googlecode.com/svn/trunk/src/main/java/fr/vekia/VkGraph/client/charts/EventBinder.java $
 * $Id: EventBinder.java 32 2012-08-30 13:58:24Z steeve.vandecappelle@gmail.com $
 * Licence MIT
 *
 * Last change:
...
public class EventBinder {
	...
	for (JqPlotEvent event : bindedEvents) {
		...
		JsConsole
			.warn("[W400CE]", Integer.toString(event.getEventBindingParams()),
				"The event cannot be binded because of invalid number of event binding params. DebugParam:\nContact a VklGraph commiter by reporting an issue.");
	    }
	}
    }
