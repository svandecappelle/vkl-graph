...
public class JQueryDialog extends SimplePanel implements ResizeHandler, HasResizeHandlers {
    ...
    public void show() {
        ...
        Scheduler.get().scheduleDeferred(new ScheduledCommand() {
            ...
            public void execute() {
                ...
                if (javaCode != null) {
                    buildCodeMirror(codeElementId, javaCode);
                }
            }
        });
    };
    ...
    public void setCode(String javaCode) {
        // this.scrollableContent.getElement().setInnerHTML(javaCode);
    ...
    private native void buildCodeMirror(String idHtml, String javaCode) /*-{
        console.log(idHtml);
        console.log($wnd.jQuery("#"+idHtml));
        var myCodeMirror = $wnd.CodeMirror($wnd.document.getElementById(idHtml), {
          value: javaCode,
          mode:  "html"
        });
    }-*/;
